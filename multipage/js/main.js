...
(function ($) {
    ...
    if ($(".bordered").hasClass("shop-border")) {
    ...
    $(".options-links .bordered").on("click", function() {
        $(".compare-basket").removeClass("boxed");
        ...
        $(".masonry-2col").masonry("layout");
        //agency 2
        $(".gallery-masonry").isotope("layout");
        $(".gallery-filterable").isotope("layout");
    ...
    // template switching
    $(".options-links .boxed").on("click", function() {
        $("body").removeClass("bordered").addClass("boxed");
        $(".compare-basket").addClass("boxed");
        if ($("#wrapper").hasClass("main-wrapper boxed")) {

        }else {
            $("#wrapper").removeClass("bordered").addClass("main-wrapper boxed");
        }
        $("body").find(bordered).remove();
    ...
    $(".options-links .wide").on("click", function() {
        $(".compare-basket").removeClass("boxed");
        $("body").removeClass("bordered");
        if ($("#wrapper").hasClass("main-wrapper")) {

        }else {
            $("#wrapper").removeClass("bordered").addClass("main-wrapper");
        }
    ...
    $("#header_switch").on('change',function(ev){
        var url = "http://192.168.1.18/eydia/multipage/bordered/"
        var header = $(this).val();
        var headerTypes = [
                            "header_v1",
                            "header_v2",
    ...
    $("#dropdown_switch").on("change",function(){
        //var url = 'http://localhost/carna/?header='
        var dropdownStyle = $(this).val();
        $(".navbar-default .navbar-nav").removeClass(dropDownColor).addClass(dropdownStyle);
    });
...
=================================================================*/
    ...
    //expandable product home-shop.php
...
if (Modernizr.csscalc) {
    $("html").addClass("csscalc-support");
} else {
    $("html").addClass("csscalc-notsupport");
}