...
(function ($) {
    ...
    $("body > header, body > section, body > div:not(.preview-pannel) , body > aside , body > footer").wrapAll('<div id="wrapper" class="main-wrapper"></div>');
    ...
    $(".options-links .wide").on("click", function() {
        $("body").find(bordered).remove();
        $("body").removeClass("boxed").removeClass("bordered");
        $("#wrapper").removeClass("boxed").removeClass("bordered").addClass('main-wrapper');
